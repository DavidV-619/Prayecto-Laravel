                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{route('empleado.store')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="number" name="sueldo" id="sueldo" class="form-control input-sm" placeholder="Sueldo Quincenal" value="{{ old('sueldo') }}">
                                </div>
                            </div>
